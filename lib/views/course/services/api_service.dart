...
class ApiService {
  static const String _baseUrl =
      "http://10.0.2.2:8000"; // Remove trailing slash
  static const String _categoryUrl = "$_baseUrl/courses/api/categories/";
  static const String _courseUrl = "$_baseUrl/courses/api/courses/";
